...
public class OracleBlockTest11 extends OracleTest {
    ...
    public void test_0() throws Exception {
        String sql = "DROP TABLE emp;" + "CREATE TABLE emp AS SELECT * FROM employees;" + " " + "DECLARE" + "  CURSOR c1 IS"
                ...
                + "    DBMS_OUTPUT.PUT_LINE (" + "      'emp_rec.employee_id = ' ||" + "      TO_CHAR(emp_rec.employee_id)"
